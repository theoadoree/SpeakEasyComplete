...
const authRoutes = require('../routes/auth-routes'); // Firebase auth routes
const { initializeSecrets, getSecrets } = require('../config/init-secrets'); // Secret Manager integration
